...
var areabtn = $('#ft-area');
var area = $('.area-wrapper'); // 選職務

var industrybtn = $('#ft-industry');
var industry = $('.industry-wrapper'); // 選福利

var benefitbtn = $('#ft-benefits');
var benefits = $('.benefits-wrapper'); // 共用背景＆彈窗＆叉叉按鈕＆回上一層

var filterbg = $('.dialog-bg');
var filterbox = $('.dialog-filter');
var closeBtn = $('.dialog-filter .close-btn');
var basic = $('.dialog-filter .fixed .basic');
var back = $('.dialog-filter .fixed .rwd-back');
